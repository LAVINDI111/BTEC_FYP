...
-- Dumping data for table db_of_acnsms.audit_log: ~42 rows (approximately)
...
-- Dumping data for table db_of_acnsms.reschedule: ~3 rows (approximately)
...
REPLACE INTO `schedule` (`id`, `date`, `start_time`, `end_time`, `subject`, `status`, `google_calendar_link`, `created_at`, `room_id`, `lecturer_id`, `program_id`, `module_id`) VALUES
	(10, '2025-08-03', '09:00:00', '05:00:00', '(auto)', 'Scheduled', NULL, '2025-07-16 12:26:15', 1, 1, 1, 1),
